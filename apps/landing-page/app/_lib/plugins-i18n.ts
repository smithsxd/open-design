...
const en: PluginsCopy = {
  ...
  browseSystems: 'Browse design systems',
  ...
  systemsLabel: 'Plugins · Design Systems',
...
const overrides: Partial<Record<LandingLocaleCode, Partial<PluginsCopy>>> = {
  ...
  'zh-tw': {
    ...
    browseTemplates: '瀏覽範本', browseSkills: '瀏覽技能', browseSystems: '瀏覽設計系統', browseCraft: '瀏覽工藝',
  ...
  ja: {
    ...
    tileTemplates: 'テンプレート', tileSkills: 'スキル', tileSystems: 'デザインシステム', tileCraft: 'クラフト',
    browseTemplates: 'テンプレートを見る', browseSkills: 'スキルを見る', browseSystems: 'デザインシステムを見る', browseCraft: 'クラフトを見る',
  ...
  ko: {
    ...
    tileTemplates: '템플릿', tileSkills: '스킬', tileSystems: '디자인 시스템', tileCraft: '크래프트',
    browseTemplates: '템플릿 보기', browseSkills: '스킬 보기', browseSystems: '디자인 시스템 보기', browseCraft: '크래프트 보기',
  ...
  de: {
    ...
    tileTemplates: 'Vorlagen', tileSkills: 'Skills', tileSystems: 'Design-Systeme', tileCraft: 'Handwerk',
    browseTemplates: 'Vorlagen ansehen', browseSkills: 'Skills ansehen', browseSystems: 'Design-Systeme ansehen', browseCraft: 'Handwerk ansehen',
    ...
    systemsLabel: 'Plugins · Design-Systeme',
  ...
  fr: {
    ...
    tileTemplates: 'Modèles', tileSkills: 'Skills', tileSystems: 'Design Systems', tileCraft: 'Artisanat',
    browseTemplates: 'Parcourir les modèles', browseSkills: 'Parcourir les skills', browseSystems: 'Parcourir les design systems', browseCraft: 'Parcourir l’artisanat',
  ...
  ru: {
    ...
    tileTemplates: 'Шаблоны', tileSkills: 'Скиллы', tileSystems: 'Дизайн-системы', tileCraft: 'Ремесло',
    browseTemplates: 'Все шаблоны', browseSkills: 'Все скиллы', browseSystems: 'Все дизайн-системы', browseCraft: 'Все правила ремесла',
    ...
    systemsLabel: 'Плагины · Дизайн-системы',
  ...
  es: {
    ...
    tileTemplates: 'Plantillas', tileSkills: 'Skills', tileSystems: 'Sistemas de diseño', tileCraft: 'Oficio',
    browseTemplates: 'Ver plantillas', browseSkills: 'Ver skills', browseSystems: 'Ver sistemas de diseño', browseCraft: 'Ver oficio',
    ...
    systemsLabel: 'Plugins · Sistemas de diseño',
    systemsHeading: (n) => `${n} design systems.`,
  ...
  'pt-br': {
    ...
    tileTemplates: 'Templates', tileSkills: 'Skills', tileSystems: 'Sistemas de design', tileCraft: 'Ofício',
    browseTemplates: 'Ver templates', browseSkills: 'Ver skills', browseSystems: 'Ver sistemas de design', browseCraft: 'Ver ofício',
    ...
    systemsLabel: 'Plugins · Sistemas de design',
    systemsHeading: (n) => `${n} design systems.`,
  ...
  it: {
    ...
    tileTemplates: 'Modelli', tileSkills: 'Skill', tileSystems: 'Design system', tileCraft: 'Artigianato',
    browseTemplates: 'Esplora modelli', browseSkills: 'Esplora skill', browseSystems: 'Esplora design system', browseCraft: 'Esplora artigianato',
    ...
    systemsLabel: 'Plugin · Design system',
  ...
  id: {
    ...
    tileTemplates: 'Template', tileSkills: 'Skill', tileSystems: 'Sistem desain', tileCraft: 'Kerajinan',
    browseTemplates: 'Jelajahi template', browseSkills: 'Jelajahi skill', browseSystems: 'Jelajahi sistem desain', browseCraft: 'Jelajahi kerajinan',
    ...
    systemsLabel: 'Plugin · Sistem desain',
    systemsHeading: (n) => `${n} design system.`,
  ...
  pl: {
    ...
    tileTemplates: 'Szablony', tileSkills: 'Umiejętności', tileSystems: 'Systemy designu', tileCraft: 'Rzemiosło',
    browseTemplates: 'Przeglądaj szablony', browseSkills: 'Przeglądaj skille', browseSystems: 'Przeglądaj systemy designu', browseCraft: 'Przeglądaj rzemiosło',
    ...
    systemsLabel: 'Wtyczki · Systemy designu',
  ...
  ar: {
    ...
    tileTemplates: 'قوالب', tileSkills: 'مهارات', tileSystems: 'أنظمة التصميم', tileCraft: 'حِرَفية',
    browseTemplates: 'تصفح القوالب', browseSkills: 'تصفح المهارات', browseSystems: 'تصفح أنظمة التصميم', browseCraft: 'تصفح الحِرَفية',
    ...
    systemsLabel: 'إضافات · أنظمة التصميم',
  ...
  tr: {
    ...
    tileTemplates: 'Şablonlar', tileSkills: 'Yetenekler', tileSystems: 'Tasarım sistemleri', tileCraft: 'Zanaat',
    browseTemplates: 'Şablonları gözat', browseSkills: 'Yetenekleri gözat', browseSystems: 'Tasarım sistemlerini gözat', browseCraft: 'Zanaatı gözat',
    ...
    systemsLabel: 'Eklentiler · Tasarım sistemleri',
  ...
  uk: {
    ...
    tileTemplates: 'Шаблони', tileSkills: 'Навички', tileSystems: 'Дизайн-системи', tileCraft: 'Ремесло',
    browseTemplates: 'Переглянути шаблони', browseSkills: 'Переглянути навички', browseSystems: 'Переглянути дизайн-системи', browseCraft: 'Переглянути ремесло',
    ...
    systemsLabel: 'Плагіни · Дизайн-системи',
    systemsHeading: (n) => `${n} дизайн-систем.`,
  ...
  vi: {
    ...
    tileTemplates: 'Mẫu', tileSkills: 'Kỹ năng', tileSystems: 'Hệ thống thiết kế', tileCraft: 'Thủ công',
    browseTemplates: 'Xem các mẫu', browseSkills: 'Xem kỹ năng', browseSystems: 'Xem hệ thống thiết kế', browseCraft: 'Xem thủ công',
    ...
    systemsLabel: 'Plugin · Hệ thống thiết kế',
    systemsHeading: (n) => `${n} design system.`,
  ...
  nl: {
    ...
    tileTemplates: 'Templates', tileSkills: 'Skills', tileSystems: 'Designsystemen', tileCraft: 'Vakmanschap',
    browseTemplates: 'Bekijk templates', browseSkills: 'Bekijk skills', browseSystems: 'Bekijk designsystemen', browseCraft: 'Bekijk vakmanschap',
    ...
    systemsLabel: 'Plug-ins · Designsystemen',
