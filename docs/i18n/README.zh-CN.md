...
> **[Claude Design][cd] 的开源替代，也是面向设计的本地 Agent 客户端。**
>
> 本地客户端优先，已支持 macOS 和 Windows；可接入 OpenClaw、Claude Code、Codex、Hermes Agent、Claude Desktop for Mac 等 **16 个 Coding Agent**。
>
> 接入现有 GitHub 仓库、Figma 文件、本地代码或零散设计物料，先沉淀成可复用的 [`DESIGN.md`](../../design-systems/README.md) Design System，再基于它生成原型、Slides、图片、视频和 HyperFrames。
>
> OD 会记住你确认过的字体、色彩、布局和交付偏好，并在新项目里继续应用；用得越多，它越像你的团队设计助手。

---

## 📋 What

✨ **Open Design（OD）是 [Claude Design][cd] 的开源替代：本地优先、Agent 驱动、会沉淀团队审美与工作流。**

📝 从一句需求开始，也可以直接选模板，生成原型、Live Artifact、Slides、图片、视频、音频。
...
**Brief → 模板 / Plugin → 视觉方向 → Design System → Artifact → Handoff → 记忆沉淀**
...
- **在线部署与分享** — HTML / Slides / Artifact 一键部署，在线 URL 分享，Plugin 社媒分享
...
欢迎所有形式的贡献——新 Plugin、新 Design System、Bug 修复、文档翻译。
